...
def get_loader(args):
    ...
    train_sampler = RandomSampler(trainset, num_samples=512) if args.local_rank == -1 else DistributedSampler(trainset)
    test_subset = Subset(testset, indices=range(128))
